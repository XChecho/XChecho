...
- **International Deployment:** Developed and deployed native apps for global clients such as **Nutrihorto (Brazil)** and **Nara (North America)**.
- **Award Winner:** Received the **Ingenia 2021 Award** for a logistics improvement project that optimized supply chain efficiency.
- **High Performance:** Achieved a **92% service level** with a lead-time of less than 6 days during my tenure as a Product Manager.
- **Optimization:** Expert in migrating legacy systems to modern versions (React/NextJS) and improving visual/responsive layouts.
...
## 🎓 Education
- **Mechatronics Engineer** - Universidad Tecnológica de Pereira (2016)
